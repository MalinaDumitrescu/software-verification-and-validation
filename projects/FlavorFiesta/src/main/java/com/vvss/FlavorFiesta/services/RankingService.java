...
public class RankingService {
    ...
    public List<RankedItem<User>> getUserRankingWithLowestReviewRatings() {
        ...
        return rankItems(reviewCounts, false);
    }
    ...
    private <T> List<RankedItem<T>> rankItems(Map<T, Long> data) {
        return rankItems(data, true);
    }

    private <T> List<RankedItem<T>> rankItems(Map<T, Long> data, boolean descending) {
        java.util.Comparator<Map.Entry<T, Long>> comparator = Map.Entry.comparingByValue();
        if (descending) {
